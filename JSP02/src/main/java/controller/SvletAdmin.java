...
public class SvletAdmin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String url = "/viewAdmin.jsp";
        if (action.equals("viewAdmin"))
            url = "/viewAdmin.jsp";
        else if (action.equals("listUsers")) {
            url = "/listUsers.jsp";
            ArrayList<User> users = UsermySQLDB.listUsers();
            req.setAttribute("users", users);
        } else if (action.equals("viewDetail")) {
            int id = Integer.parseInt(req.getParameter("id"));
            System.out.println(id);
            url = "/viewDetail.jsp";
            User user = UsermySQLDB.getUserDetail(id);
            ...
            url = "/listRoles.jsp";
            ArrayList<Role> roles = RoleMySQL.listUsers();
            req.setAttribute("roles", roles);
        } else if (action.equals("updateRole")) {
            int id = Integer.parseInt(req.getParameter("id"));
            url = "/updateRole.jsp";
            Role role = RoleMySQL.getRoleDetail(id);
            req.setAttribute("role", role);
        } else if (action.equals("setUserRole")) {
            url = "/addUserRole.jsp";
            ArrayList<Role> roles = RoleMySQL.listUsers();
            req.setAttribute("roles", roles);
            ArrayList<User> users = UsermySQLDB.listUsers();
